...
require('lazy').setup({
  ...
  },
  {
    ...
    keys = {
      ...
      { '<leader>ff', '<cmd>FzfLua live_grep<cr>', desc = 'Find (live_grep)' },
      { '<leader>fh', '<cmd>FzfLua live_grep multiline=true<cr>', desc = 'Find (live_grep multiline)' },
    },
  },
...
local v = {
  ...
  ls.parser.parse_snippet('cll', 'console.log($1)'),
  ls.parser.parse_snippet('cll', 'console.log("$1")'),
  ls.parser.parse_snippet('cll', 'console.log(e)'),
